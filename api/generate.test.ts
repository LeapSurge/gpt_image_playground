...
describe('api/generate', () => {
  ...
  it('returns NDJSON immediately for 1K requests and emits heartbeat before the final result', async () => {
    vi.useFakeTimers()
  ...
  it('streams an error event when a request fails after the stream starts', async () => {
