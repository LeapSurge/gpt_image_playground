...
const STARTER_EXAMPLES: StarterExample[] = [
  ...
  },
  {
    ...
    prompt: [
      ...
      '节日标签：劳动节、青年节，并保留“宪法纪念日、绿之日、儿童节、补假”风格的节假日标签视觉效果。',
  ...
  return (
    <section className="rounded-[28px] border border-white/60 bg-white/80 p-5 shadow-[0_16px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/[0.08] dark:bg-gray-900/70 dark:shadow-[0_16px_50px_rgba(0,0,0,0.28)]">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-semibold tracking-[0.18em] text-blue-500 dark:text-blue-300">首图案例辅助</p>
          <h2 className="mt-1 text-xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">不会写提示词，先试一个案例</h2>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">点击示例会直接填入输入框。你只需要改几个词，就能开始生成第一张图。</p>
        </div>
        <div className="text-xs text-gray-400 dark:text-gray-500">先写主体，再补风格和场景</div>
      </div>
